...
const ja: typeof en = {
  ...
  about: {
    kicker: "00 — 株式会社 遊行",
    heading: "境界を、<br>ほどく。",
    body: "株式会社 遊行は、日本における「あなたのローカルチーム」です。コンサルティングとマーケティングを軸に、デジタルノマド・地域共創・教育の領域で、世界の企業やパートナーが日本に入り、育ち、根づくことを支えます。戦略から現場の実装まで、目的に並走します。",
    note: "<b>遊行（ゆぎょう）</b> — 巡ることを修行とする、という意味。社名は「歩く」という行為に由来します。まず動く。仕事はその後についてくる。",
  },
  ...
  whatwedo: {
    ...
    lead: "解釈する。日本文化の深い目を読み、意味を運ぶ。日本が送り、世界が受けとる。",
  ...
  pages: {
    ...
    news: { title: "ニュース", subtitle: "株式会社 遊行 からの公式お知らせ" },
